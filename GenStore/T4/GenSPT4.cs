...
#line hidden
 ...
 foreach (var sp in SpList){ if (sp.Results.Count > 0) {
            ...
            #line 33 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(DestinationDbContext));
...
if (sp.Params.Count > 0) {
            ...
            #line 54 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
 foreach (var p in sp.Params){ 
...
if (sp.Results.Count > 0) {
            ...
            #line 62 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(sp.Name));
 ...
 foreach (var p in sp.Params){ 
            ...
            #line 65 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
 foreach (var p in sp.Params){ 
            ...
            #line 67 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
if (sp.Params.Where(x=> x.isOutput).Count() > 0) {
            ...
            #line 70 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
...
");
            ...
            #line 87 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
 foreach (var sp in SpList){ 
...
if (sp.Results.Count > 0) {
            ...
            #line 104 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
}
            ...
            #line 107 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
 foreach (var p in sp.Params){ 
...
");
            ...
            #line 122 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
}
            ...
            #line 124 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
 }
 ...
 foreach (var r in sp.Results){
            ...
            #line 141 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
 foreach (var sp in SpList){ if (sp.Results.Count > 0){
            ...
            #line 142 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(sp.Name));
 ...
 foreach (var r in sp.Results){
            ...
            #line 145 "D:\Project\GenStore_UI\GenStore\T4\GenSPT4.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(r.Type));
